...
describe('AuthController', () => {
    let authService: AuthService, passwordService: PasswordService, repository: UserRepository,
    ...
    describe('refresh', () => {
        ...
        it('uses auth service to decode token', async () => {
            ...
            expect(authService.decodeToken).toHaveBeenCalledWith(dto.refreshToken, JwtTokenTypeEnum.refreshToken);
        });
